[![Run App EllieAllen](https://github.com/eallen13/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/eallen13/GithubActions/actions/workflows/run-app.yaml)
